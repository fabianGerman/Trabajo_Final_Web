class MainScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.ListaPlataforma(); 
         ...
         this.portalSub = this.physics.add.sprite(20 * 700, 460, 'portal')
        .setOrigin(0,1);
        this.portalSub.body.velocity.x = -600;
        this.physics.add.overlap(this.player, this.portalSub, this.onChangetoSub, null, this);
        this.portalSub1 = this.physics.add.sprite(40 * 700, 460, 'portal')
        .setOrigin(0,1);
        this.portalSub1.body.velocity.x = -600;
        this.physics.add.overlap(this.player, this.portalSub1, this.offChangetoSub, null, this);
        this.minas = this.physics.add.group();
        this.ListaMinas(); 
        this.cofre = this.physics.add.sprite(49.5 * 700, 250, 'cofre');
        this.cofre.body.velocity.x = -600;
    ...
    ListaPlataforma() {
        ...
        this.plataformas.setVelocityX(-600);
    }
    ListaMinas(){
